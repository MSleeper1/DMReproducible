...
#SBATCH --mem=80gb                              # memory pool to all cores
...
#-----------------------------------------------------------------------------------#
# crossmaped_bam2pat.sh
#
# input crossmapped bam files
# outputs crossmapped beta and pat files
#
# options:
#   -w indicates where to navigate to for access to bam files
#   non-option args should be the bam files being processed
#
# sbatch crossmapped_bam2pat.sh -w [directory/path] [bam-file-1] [bam-file-2] bam-file-3]...
#
#-----------------------------------------------------------------------------------#
...
mkdir -p /home/msleeper/scratch/data/07_wgbstools_betas_bwa/crossmap_hg38Tohg19
mkdir -p /home/msleeper/scratch/data/07_wgbstools_betas_bwa/crossmap_hg38Tohg19/tmp
...
for i; do
    ...
    # bam2pat on each bam file input
    echo "Running bam2pat for $i"
    wgbstools bam2pat -f --out_dir /home/msleeper/scratch/data/07_wgbstools_betas_bwa/crossmap_hg38Tohg19 --mbias --genome hg19 --temp_dir /home/msleeper/scratch/data/07_wgbstools_betas_bwa/crossmap_hg38Tohg19/tmp $i
    FILES+=($i)
...
echo "beta outputs for bam files:${FILES[@]} can be found in /home/msleeper/scratch/data/07_wgbstools_betas_bwa/crossmap_hg38Tohg19"
