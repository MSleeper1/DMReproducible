...
rule multiqc_compile_reports_01:
    ...
    output:
        input_list = expand("{root}/{rep_dir}/summary/01_qc_report_list.txt", root = config["root"], rep_dir=config["reports_dir"]),
        multiqc_command = expand("{root}/{rep_dir}/summary/01_multiqc_command.sh", root = config["root"], rep_dir=config["reports_dir"]),
        file = expand("{root}/{rep_dir}/summary/01_raw_multiqc.html", root = config["root"], rep_dir=config["reports_dir"])
    log:
