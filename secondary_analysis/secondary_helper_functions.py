...
def get_sample_info_df(input_tsv):
    ...
    # Verify column names
    if not {'ref', 'patient_id', 'srx_id', 'accession', 'layout', 'group'}.issubset(sample_info.columns.values):
        raise KeyError("The sample info file must contain the following named columns: 'ref', 'patient_id', 'srx_id', 'accession', 'layout', 'group'")
